  ...
  return (
    ...
    viewport={{once:true}} className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        {state !== 'Login' && <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
            ...
            <input type='text' placeholder='full name' className='outline-non text-sm' required/> 
        </div>}

        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img src={assets.email_icon} alt=''/>
            <input type='email' placeholder='Email' className='outline-non text-sm' required/> 
        </div>

        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img src={assets.lock_icon} alt=''/>
            <input type='password' placeholder='Password' className='outline-non text-sm' required/> 
        </div>
